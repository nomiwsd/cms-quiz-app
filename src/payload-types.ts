...
/**
 * Quiz questions. Each must have exactly 4 options scored 0–3.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Question {
  ...
  text: string;
  /**
   * Controls the question sequence (1–10)
   */
  order: number;
  /**
   * Exactly 4 options required. Score range: 0 (lowest) to 3 (highest).
   */
  options?:
    | {
        label: string;
...
/**
 * Quiz submissions. Notes field is Caesar-cipher encrypted at rest.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface QuizResult {
  ...
  notes?: string | null;
  /**
   * Array of { questionId, questionText, selectedLabel, score }
   */
  breakdown?:
    | {
        [k: string]: unknown;
